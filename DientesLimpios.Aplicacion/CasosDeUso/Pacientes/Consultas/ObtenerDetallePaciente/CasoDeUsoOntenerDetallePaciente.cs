...
{
    public class CasoDeUsoOntenerDetallePaciente : IRequestHandler<ConsultaObtenerDetallePaciente, PacienteDetalleDTO>
    {
        IRepositorioPacientes repositorio;

        public CasoDeUsoOntenerDetallePaciente(IRepositorioPacientes repositorio)
        {
