...
namespace DientesLimpios.Persistencia.Repositorios
{
    public class Repositorio<T> : IRepositorio<T> where T : class
    {
        ...
        //Se va implementar tambien el patro UnitOfWork - Unidad de Trabajo
        //los metodos simplemente harán la operación sin persistir los cambios
        //porque persistencia se le dejará a una clase especial
