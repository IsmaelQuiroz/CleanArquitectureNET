...
namespace DientesLimpios.Pruebas.Aplicacion.CasosDeUso.Pacientes
{
    ...
    public class CasoDeUsoCrearPacientesTest
    {
       ...
       public void Setup()
        ...
        [TestMethod]
        public async Task Handle_comandoValido_ObtenemosIdPaciente()
        {
            var comando = new ComandoCrearPaciente { Nombre = "Paciente A", Email = "pacientea@mail.com" };
        ...
        {
            var comando = new ComandoCrearPaciente { Nombre = "paciente B", Email = "paciente@maili.com" };
